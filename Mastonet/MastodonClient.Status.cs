...
namespace Mastonet
{
    partial class MastodonClient
    {
        ...
        public Task<MastodonList<Account>> GetRebloggedBy(string statusId, string? maxId = null, string? sinceId = null, int? limit = null)
        {
        ...
        /// <param name="limit ">Maximum number of items to get (Default 40, Max 80)</param>
        /// <returns>Returns an array of Accounts</returns>
        public Task<MastodonList<Account>> GetFavouritedBy(string statusId, string? maxId = null, string? sinceId = null, int? limit = null)
        {

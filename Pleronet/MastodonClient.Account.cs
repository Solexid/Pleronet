...
namespace Pleronet
{
    partial class MastodonClient
    {
        ...
        public Task<MastodonList<Account>> GetAccountFollowers(string accountId, string? maxId = null, string? sinceId = null, int? limit = null)
        {
        ...
        /// <param name="limit ">Maximum number of items to get (Default 40, Max 80)</param>
        /// <returns>Returns an array of Accounts</returns>
        public Task<MastodonList<Account>> GetAccountFollowing(string accountId, string? maxId = null, string? sinceId = null, int? limit = null)
        {
        ...
        public Task<MastodonList<Status>> GetAccountStatuses(string accountId, string? maxId = null, string? sinceId = null, int? limit = null, bool onlyMedia = false, bool excludeReplies = false, bool pinned = false, bool excludeReblogs = false)
        {
        ...
        public Task<MastodonList<Account>> GetFollowRequests(string? maxId = null, string? sinceId = null, int? limit = null)
        {
        ...
        public Task<MastodonList<Status>> GetFavourites(string? maxId = null, string? sinceId = null, int? limit = null)
        {
